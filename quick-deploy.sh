...
ENABLE_COMBINED_SEARCH=${ENABLE_COMBINED_SEARCH:-true}
...
DOCUMENT_UPLOAD_RATE_WINDOW=${DOCUMENT_UPLOAD_RATE_WINDOW:-5}
DOCUMENT_UPLOAD_RATE_MAX_SINGLE=${DOCUMENT_UPLOAD_RATE_MAX_SINGLE:-30}
DOCUMENT_UPLOAD_RATE_MAX_BATCH=${DOCUMENT_UPLOAD_RATE_MAX_BATCH:-20}
