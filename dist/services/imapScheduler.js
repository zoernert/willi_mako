    ...
    async processEmail(email, teamId) {
        try {
            ...
            if (extractedData && extractedData.confidence > 0.7) {
                ...
                const clarification = await this.autoKlärfallService.createFromEmail(email, extractedData, teamId);
                if (clarification) {
                ...
                console.log(`⚠️  Low confidence for email extraction: ${(extractedData === null || extractedData === void 0 ? void 0 : extractedData.confidence) || 0}`);
            }
        }
        catch (error) {
...
//# sourceMappingURL=imapScheduler.js.map