...
class EmailService {
     ...
     */
    async sendMarketPartnerErrorReport(reporterEmail, reporterName, marketPartner, errorDescription) {
     ...
     */
    generateErrorReportHTML(reporterEmail, reporterName, marketPartner, errorDescription) {
    ...
    <body>
        <div class="container">
            ...
            marketPartner.contacts.map((contact, index) => `
     ...
     */
    generateProblemReportHTML(data) {
        const currentDate = new Date().toLocaleDateString('de-DE');
        const currentTime = new Date().toLocaleTimeString('de-DE');
        return `
    <!DOCTYPE html>
