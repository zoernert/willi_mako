            ...
            if (response && response.trim()) {
                try {
                    ...
                    if (parsedData.process_steps && Array.isArray(parsedData.process_steps) &&
                        ...
                        const validSteps = parsedData.process_steps.every((step) => step.id && step.label && typeof step.id === 'string' && typeof step.label === 'string');
                        const validConnections = parsedData.connections.every((conn) => conn.from && conn.to && typeof conn.from === 'string' && typeof conn.to === 'string');
    ...
    static async searchProcesses(request) {
        try {
            ...
            const diagrams = await Promise.all(mermaidResults.map(async (result, index) => {
                ...
                if (((_a = result.payload) === null || _a === void 0 ? void 0 : _a.process_data) && typeof result.payload.process_data === 'object') {
                    mermaidCode = this.generateMermaidFromStructuredData(result.payload.process_data);
                    return {
                        id: ((_b = result.id) === null || _b === void 0 ? void 0 : _b.toString()) || `diagram_${index}`,
                        title: ((_c = result.payload) === null || _c === void 0 ? void 0 : _c.context_text) || `Prozessdiagramm ${index + 1}`,
                    ...
                    console.log(`🔄 Attempting to generate structured data using LLM for diagram: ${((_e = result.payload) === null || _e === void 0 ? void 0 : _e.context_text) || result.id}`);
                    try {
                        const generatedData = await this.generateStructuredDataFromMetadata({
                            id: ((_f = result.id) === null || _f === void 0 ? void 0 : _f.toString()) || `diagram_${index}`,
                            title: ((_g = result.payload) === null || _g === void 0 ? void 0 : _g.context_text) || `Prozessdiagramm ${index + 1}`,
                            content: ((_h = result.payload) === null || _h === void 0 ? void 0 : _h.content) || 'Keine Beschreibung verfügbar',
                            mermaid_code: ((_j = result.payload) === null || _j === void 0 ? void 0 : _j.mermaid_code) || undefined
                        });
                        ...
                        return {
                            id: ((_k = result.id) === null || _k === void 0 ? void 0 : _k.toString()) || `diagram_${index}`,
                            title: ((_l = result.payload) === null || _l === void 0 ? void 0 : _l.context_text) || `Prozessdiagramm ${index + 1}`,
                            content: ((_m = result.payload) === null || _m === void 0 ? void 0 : _m.content) || 'Keine Beschreibung verfügbar',
                            mermaidCode: mermaidCode,
                            score: result.score || 0,
                        ...
                        return {
                            id: ((_o = result.id) === null || _o === void 0 ? void 0 : _o.toString()) || `diagram_${index}`,
                            title: ((_p = result.payload) === null || _p === void 0 ? void 0 : _p.context_text) || `Prozessdiagramm ${index + 1}`,
                            content: ((_q = result.payload) === null || _q === void 0 ? void 0 : _q.content) || 'Keine Beschreibung verfügbar',
                            mermaidCode: mermaidCode,
                            score: result.score || 0,
                        };
                    }
...
Format: Einfache Liste ohne Nummerierung.`;
    ...
    static async findRelatedProcesses(diagram) {
        try {
            ...
            const relatedDiagrams = await Promise.all(results
                .filter((result) => {
                var _a, _b;
                ...
                if (((_a = result.payload) === null || _a === void 0 ? void 0 : _a.process_data) && typeof result.payload.process_data === 'object') {
                    ...
                    try {
                        const generatedData = await this.generateStructuredDataFromMetadata({
                            id: ((_b = result.id) === null || _b === void 0 ? void 0 : _b.toString()) || `related_${index}`,
                            title: ((_c = result.payload) === null || _c === void 0 ? void 0 : _c.context_text) || `Verwandter Prozess ${index + 1}`,
                            content: ((_d = result.payload) === null || _d === void 0 ? void 0 : _d.content) || 'Keine Beschreibung verfügbar',
                            mermaid_code: ((_e = result.payload) === null || _e === void 0 ? void 0 : _e.mermaid_code) || undefined
                        });
                        mermaidCode = this.generateMermaidFromStructuredData(generatedData);
                    }
                    catch (error) {
                ...
                return {
                    id: ((_f = result.id) === null || _f === void 0 ? void 0 : _f.toString()) || `related_${index}`,
                    title: ((_g = result.payload) === null || _g === void 0 ? void 0 : _g.context_text) || `Verwandter Prozess ${index + 1}`,
                    content: ((_h = result.payload) === null || _h === void 0 ? void 0 : _h.content) || 'Keine Beschreibung verfügbar',
                    mermaidCode: mermaidCode,
                    score: result.score || 0,
                };
