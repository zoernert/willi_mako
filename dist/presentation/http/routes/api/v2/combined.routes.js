...
/**
 * POST /api/v2/combined/semantic-search
 * Semantische Suche übergreifend über willi_mako und willi-netz Collections
 */
router.post('/semantic-search', auth_1.authenticateToken, (0, rateLimiter_1.apiV2RateLimiter)(), (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const result = await retrieval_service_1.retrievalService.semanticSearchCombined(query, parsedOptions);
...
/**
 * POST /api/v2/combined/chat
 * Chat übergreifend über willi_mako und willi-netz Collections
 */
router.post('/chat', auth_1.authenticateToken, (0, rateLimiter_1.apiV2RateLimiter)(), (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const enhancedContextSettings = {
        ...contextSettings,
        targetCollections: ['willi_mako', 'willi-netz']
    };
...
//# sourceMappingURL=combined.routes.js.map