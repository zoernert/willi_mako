    ...
    try {
        ...
        res.json({
            ...
            pagination: {
                ...
                total: ((_a = result.rows[0]) === null || _a === void 0 ? void 0 : _a.total_count) || 0,
                totalPages: Math.ceil((((_b = result.rows[0]) === null || _b === void 0 ? void 0 : _b.total_count) || 0) / limit)
            },
            stats
        });
    }
...
router.post('/:id/llm-suggestions', async (req, res) => {
    ...
    try {
        ...
        const emailData = {
            ...
            from: ((_a = clarification.original_email) === null || _a === void 0 ? void 0 : _a.from) || 'Unbekannt'
        };
        let suggestions;
        switch (requestType) {
            case 'analysis':
...
//# sourceMappingURL=bulk-clarifications-temp.js.map