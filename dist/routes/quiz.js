...
function createQuizRoutes(db) {
    ...
    router.post('/quizzes/generate', auth_1.authenticateToken, async (req, res) => {
        ...
        try {
            ...
            if (questions.length === 0) {
                ...
                const fallbackQuestions = await quizService.generateQuestionsFromFAQs(undefined, difficulty, questionCount);
    ...
    router.post('/quizzes/generate-from-chats', auth_1.authenticateToken, async (req, res) => {
        var _a;
        try {
            const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
            if (!userId) {
    ...
    // Admin routes
    router.get('/admin/all-quizzes', auth_1.authenticateToken, async (req, res) => {
        var _a, _b;
        try {
    ...
    router.put('/admin/quizzes/:id', auth_1.authenticateToken, async (req, res) => {
        var _a, _b;
        try {
            const userRole = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role;
            const userId = (_b = req.user) === null || _b === void 0 ? void 0 : _b.id;
    ...
    router.delete('/admin/quizzes/:id', auth_1.authenticateToken, async (req, res) => {
        var _a, _b;
        try {
            const userRole = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role;
            const userId = (_b = req.user) === null || _b === void 0 ? void 0 : _b.id;
    ...
    router.get('/admin/quizzes/:id/questions', auth_1.authenticateToken, async (req, res) => {
        var _a, _b;
        try {
            const userRole = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role;
            const userId = (_b = req.user) === null || _b === void 0 ? void 0 : _b.id;
    ...
    router.put('/admin/questions/:id', auth_1.authenticateToken, async (req, res) => {
        var _a, _b;
        try {
            const userRole = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role;
            const userId = (_b = req.user) === null || _b === void 0 ? void 0 : _b.id;
    ...
    router.delete('/admin/questions/:id', auth_1.authenticateToken, async (req, res) => {
        var _a, _b;
        try {
            const userRole = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role;
            const userId = (_b = req.user) === null || _b === void 0 ? void 0 : _b.id;
    ...
    router.post('/admin/quizzes/:id/questions', auth_1.authenticateToken, async (req, res) => {
        var _a, _b;
        try {
            const userRole = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role;
            const userId = (_b = req.user) === null || _b === void 0 ? void 0 : _b.id;
    ...
    router.post('/quizzes/create-intelligent', auth_1.authenticateToken, async (req, res) => {
        var _a;
        try {
            const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
            if (!userId) {
            ...
            const { quiz, questions } = await quizService.createIntelligentQuiz(title, description, difficulty, questionCount, userId);
            return res.json({
                quiz,
