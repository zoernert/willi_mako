    ...
    try {
        ...
        try {
            ...
            const clarificationResult = await client.query(`
                ...
                RETURNING id
            `, [title, description, category, priority, teamId, marketPartnerId, (_b = req.user) === null || _b === void 0 ? void 0 : _b.id]);
    ...
    try {
        ...
        res.json({
            ...
            pagination: {
                ...
                totalPages: Math.ceil((((_c = result.rows[0]) === null || _c === void 0 ? void 0 : _c.total_count) || 0) / limitNum)
            },
            stats
        });
    }
...
//# sourceMappingURL=bulk-clarifications-fixed.js.map