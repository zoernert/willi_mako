...
export class UserService {
  ...
  /**
   * Update user - method expected by legacy routes
   */
  async updateUser(userId: string, name?: string, company?: string): Promise<User> {
    const updates: { name?: string } = {};
    if (name) updates.name = name;
    // Note: company field is not part of the users table in our current schema
    // This method provides compatibility with legacy routes
